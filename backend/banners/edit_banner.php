                ...
                <div class="card-body">
                    <form action="update_banner.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group my-3">
                            ...
                            <input onchange="document.getElementById('blah').src = window.URL.createObjectURL(this.files[0])" type="file" class="form-control" name="banner_image">
                            
                        </div>
                        <div class="form-group my-3">
                            <h3>Present Image</h3>
                            <img id="blah" width="100" src="../../uploads/banner/<?=$after_assoc['banner_image']?>" width="100" alt="">
                        </div>
